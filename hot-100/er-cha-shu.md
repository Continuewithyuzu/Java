...
性质5: 对于具有<mark style="color:blue;">n个节点的完全二叉树</mark>，如果从上至下，从左至右的顺序对所有的节点从 0 开始进行编号，<mark style="color:blue;">如果父节点下标为 i，左孩子节点下标为：2 \* i + 1 且 < n，右孩子下标为：2 \* i + 2 且 < n</mark>，已知孩子节点下标，求父节点：(i - 1) / 2 = 父节点下标，若 i = 0，则 i 为根节点编号。&#x20;
